...
from . import BreakingBadUniform, BreakingBadWeighted, BreakingBadWeightedColor
...
class BreakingBadDataModule(L.LightningDataModule):
    def __init__(
        ...
        sample_method: Literal["uniform", "weighted", "weighted_color"] = "uniform",
        batch_size: int = 32,
        num_workers: int = 16,
        num_removal: int = 0,
        ...
        elif self.sample_method == "weighted_color":
            self.dataset_cls = BreakingBadWeightedColor
        else:
